...
public struct VerticalDivider: ModifiableView {
    ...
    public init(width: CGFloat = 1.0, verticalInset: CGFloat = 0.0, alignment: HorizontalAlignment = .center) {
        self.modifiableView = Modified(BuilderInternalVerticalDividerView(frame: .zero)) { view in
            ...
            // Pin top, bottom with insets, align horizontally, and set custom width.
